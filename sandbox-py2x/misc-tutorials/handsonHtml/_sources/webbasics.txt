...
could be produced with a plain text editor.

For instance in HTML, the largest form of a heading with the text
...
is the open source Kompozer, available at http://kompozer.net.

.. warning::
   Careful - although this is free, open source software, the URL is
   Kompozer.*net*, not Kompozer.org. There is a site Kompozer.org that
...
#. If you are in a Loyola University Windows lab, follow the
   sequence of selections
   :menuselection:`Start menu --> Loyola software --> Math and Computer Science --> Kompozer`.
   (It may be under Internet instead of Math and Computer Science
   instead.) You may get pop-up window wanting to
   count users of Kompozer. Click OK as another user of Kompozer.
...
#. Before getting too carried away, save your document as
   ...
   *www directory under your earlier Python examples*. It will save a
   ...
   directory, where I have already placed a number of files yo will
...
#. You can use your web browser to see how your file looks outside
   ...
   Kompozer, but if you put in hyperlinks, they should now be
   active.
...
...cgi
   Python program to be run by a web server.
...
...html
    ...
    a web server, where they can pass information to a Python CGI
    program (...cgi).
