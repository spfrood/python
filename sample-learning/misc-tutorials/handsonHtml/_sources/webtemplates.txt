...
#. Careful, note the change from past practice here: Start Python
   *from inside the www directory*.  In Windows start the Idle shortcut
   link that I placed *in the www directory*, not the original example
   directory.
...
to insert your special code, ``skeletonForWeb.py``.
